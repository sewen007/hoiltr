...
import chardet
import FairRank.result_graphing.plot as plot
...
#             # get all ndkl files
#             ndkl_files = []
#             files = get_files("./FairRank/Graphs/flipchoice-" + choice + "/" + experiment_name + "/" + pipe + "/")
#             for file in files:
...
#         # save to csv
#         final_combined_csv.to_csv("./FairRank/Results/" + experiment_name + "/" + pipe + "_combined_results.csv",
#                                   index=False)
#
